    ...
    <PageLayout
      ...
      content={
        <div className="space-y-8">
          {appointments.slice(0, ITEMS_PER_PAGE).map((appointment, index) => (
            <div
              key={index}
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-3 text-gray-800">{appointment.title}</h3>
